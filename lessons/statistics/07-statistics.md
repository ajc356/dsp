...
For a frequentist approach, the only hypothesis that needs to be specified in the null hypothesis  - however the rejection of the null hypothesis does not tell us which of any possible alternatives might be better supported. This frequentist interpretation draws its conclusion on the relative frequency of an event after many trials. 
